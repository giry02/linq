...
function bind(){
  ...
  $$('.filter-form input').forEach(input=>input.addEventListener('input',()=>{
    const custom=$$('.period-tabs button').find(button=>button.textContent.trim()==='사용자설정');
    if(custom)setPeriod(custom);
  }));
